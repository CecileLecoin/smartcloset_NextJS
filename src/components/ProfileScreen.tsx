...
import { Camera, ChevronRight, Palette, Sparkles, Upload, LogOut, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="h-full overflow-y-auto pb-4">
      <div className="pt-14 pb-4 text-center">
        ...
        <p className="text-xs text-dim mt-0.5">Gérer mon essayage</p>
      </div>
        ...
        {!basePhoto && (
          <div className="card p-4 mb-3 border-2 border-dashed border-primary/30 bg-primary/5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-dark mb-1">Photo requise pour essayer</p>
                <p className="text-[10px] text-dim leading-relaxed">
                  Prenez une photo de vous en <strong>plein pied</strong>, sur fond neutre, tenue simple.
                  FASHN posera vos vêtements dessus.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="card overflow-hidden">
          {basePhoto ? (
            <div className="relative">
              <img src={basePhoto} alt="Ma photo de base" className="w-full aspect-[2/3] object-cover object-top" />
            ...
            >
              {uploading ? (
                <>
                  ...
                  <p className="text-xs text-dim">Upload en cours…</p>
                </>
              ) : (
                <>
                  <Camera size={32} className="text-dim/40" />
                  <p className="text-xs text-dim text-center px-8 leading-relaxed">
                    Uploadez une photo de vous<br />
                    <span className="text-[10px] opacity-60">Plein pied · Fond neutre · Tenue simple</span>
                  </p>
      ...
      <div className="px-5 mb-5">
        ...
        <div className="card flex items-center gap-3 p-3.5 mb-1.5">
          <span className="text-lg">✦</span>
          <span className="flex-1 text-[13px] font-medium">Suggestions de marques</span>
          <div className="w-11 h-6 rounded-full bg-accent relative cursor-pointer">
        ...
        <div className="card flex items-center gap-3 p-3.5">
          ...
          <span className="flex-1 text-[13px] font-medium">Thème sombre</span>
      ...
      <div className="px-5 mb-8">
        ...
        <button className="w-full card flex items-center gap-3 p-3.5 mb-1.5 active:bg-border/30 transition-colors">
        ...
        <button className="w-full card flex items-center gap-3 p-3.5 active:bg-border/30 transition-colors">
